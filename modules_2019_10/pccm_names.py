...
def name_clinical(module_name):
    if module_name == 'clinical_exam_initial':
        col_list = ['consent_status', 'consent_form_status', 'provisional_diagnosis_clinical_examination_ce',
                    ...
                    'lump_number_ce', 'lump_consistency_ce',
                    ...
                    'rightarm_upperlimbvolume_cc_ce', 'rightarm_elbowdistance_',
                    'cm_ce', 'leftarm_circumference_cm_ce',
...
def names_pet(module_name):
    if module_name == 'pet_report_identifier':
        ...
        col_list = ['pet_breast_lesion_size', 'pet_breast_lesion_size_unit', 'pet_breast_lesion_suv',
                    'pet_breast_lesion_location', 'pet_breast_lesion_type', 'pet_breast_nodes_description',
                    'pet_breast_lesion_skin', 'update_by', 'last_update']
    else:
        col_list = ['file_number']
    return col_list